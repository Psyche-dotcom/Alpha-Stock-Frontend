    ...
    if (type == "LIABLE") {
      dataSources = [
        ...
        },
        {
          ...
          ttm: Data[0]?.treasuryStock,
          row1: Data[1]?.treasuryStock,
          row2: Data[2]?.treasuryStock,
          row3: Data[3]?.treasuryStock,
          row4: Data[4]?.treasuryStock,
          row5: Data[5]?.treasuryStock,
          row6: Data[6]?.treasuryStock,
          row7: Data[7]?.treasuryStock,
          row8: Data[8]?.treasuryStock,
          row9: Data[9]?.treasuryStock,
          row10: Data[10]?.treasuryStock,
        },
        {
          id: 47,
        ...
        },
        {
          ...
          ttm: Data[0]?.totalInvestments,
          row1: Data[1]?.totalInvestments,
          row2: Data[2]?.totalInvestments,
          row3: Data[3]?.totalInvestments,
          row4: Data[4]?.totalInvestments,
          row5: Data[5]?.totalInvestments,
          row6: Data[6]?.totalInvestments,
          row7: Data[7]?.totalInvestments,
          row8: Data[8]?.totalInvestments,
          row9: Data[9]?.totalInvestments,
          row10: Data[10]?.totalInvestments,
        },
        {
          id: 38,
    ...
    if (type == "SHARE") {
      dataSources = [
        ...
        },
        {
          ...
          ttm: Data[0]?.shortTermDebt,
          row1: Data[1]?.shortTermDebt,
          row2: Data[2]?.shortTermDebt,
          row3: Data[3]?.shortTermDebt,
          row4: Data[4]?.shortTermDebt,
          row5: Data[5]?.shortTermDebt,
          row6: Data[6]?.shortTermDebt,
          row7: Data[7]?.shortTermDebt,
          row8: Data[8]?.shortTermDebt,
          row9: Data[9]?.shortTermDebt,
          row10: Data[10]?.shortTermDebt,
        },
        {
          id: 28,
        ...
        },
        {
          ...
          title: "Prepaids",
          ttm: Data[0]?.prepaids,
          row1: Data[1]?.prepaids,
          row2: Data[2]?.prepaids,
          row3: Data[3]?.prepaids,
          row4: Data[4]?.prepaids,
          row5: Data[5]?.prepaids,
          row6: Data[6]?.prepaids,
          row7: Data[7]?.prepaids,
          row8: Data[8]?.prepaids,
          row9: Data[9]?.prepaids,
          row10: Data[10]?.prepaids,
        },
        {
          id: 34,
          title: "Tax Assets",
