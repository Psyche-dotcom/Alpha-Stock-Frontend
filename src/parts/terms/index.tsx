      ...
      <div className="gap-4 flex mt-8">
        ...
        >
          ...
          <p className="font-medium sm:text-base text-sm mb-[2rem]">
            ...
            these Terms of Use and our Privacy Policy. If you disagree with
            these terms, please do not use our Website. Alpha Strategy LLC
            ("Company," "we," or "us"), a company registered in Barcelona,
            Spain, provides this Website subject to these terms. You confirm you
            are of legal age to form binding contracts in your jurisdiction. If
            you do not meet this requirement, you must not use the Website.{" "}
            <br />
          </p>
          ...
          <p className="font-medium sm:text-base text-sm mb-[2rem]">
            ...
            immediately upon posting. Your continued use constitutes acceptance
            of revised terms. We recommend checking this page regularly.
            Accessing the Website We reserve the right to modify or discontinue
            the Website without notice. We are not liable if the Website becomes
            unavailable. You are responsible for: Arrangements necessary to
            access the Website Ensuring anyone accessing through your connection
            complies with these terms For registration, you must provide
            accurate information. Treat your account credentials as confidential
            and notify us immediately of security breaches. We may disable
            accounts that violate these terms. Intellectual Property Rights The
            Website content is owned by Alpha Strategy LLC and protected by
            Spanish, European, and international intellectual property laws. You
            may use it only for personal, non-commercial purposes. Permitted
            uses: Temporary storage in RAM while viewing Browser cache files
            Printing/downloading single copies for personal use Using social
            media features as provided You must not: Modify Website content Use
            visual elements separately from accompanying text Remove copyright
            notices For other uses, contact:{" "}
            <a
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm text-gray-700">
            ...
            <li>
              User Contributions: Interactive features allow you to post
              content. By posting, you grant us a non-exclusive, royalty-free
              license to use and display your contributions. You represent that
              you own the rights to your contributions and that they comply with
              these terms.
            </li>
          </ul>
          <br />
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm text-gray-700">
            ...
            <li>
              Copyright Infringement: We respect intellectual property rights.
              If you believe content violates your copyright, please contact us
              with details of the alleged infringement.
            </li>

            <li>
              Information Reliability: Content on the Website is for
              informational purposes only. It is not professional advice.
              Consult appropriate professionals before making decisions based on
              Website content. The Company and its affiliates are not
              responsible for:
              <ul className="list-disc pl-6 space-y-1">
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm text-gray-700">
            ...
            <li>
              Data Security: We implement reasonable security measures but
              cannot guarantee absolute security.
            </li>

            <li>
              Your Rights Under European Law: As a European user, you have
              rights to:
              <ul className="list-disc pl-6 space-y-1">
          ...
          <p className="font-medium sm:text-base text-sm mb-[2rem]">
            ...
            knowingly collect data from children. <br />
          </p>
          <br />
          <h5
            className="font-bold sm:text-2xl text-xl"
          ...
          <br />{" "}
          <p className="font-medium sm:text-base text-sm mb-[2rem]">
            We will post changes on this page and notify you of material
            changes. General Legal Provisions Limitation of Liability TO THE
            EXTENT PERMITTED BY LAW, ALPHA STRATEGY LLC SHALL NOT BE LIABLE FOR
            DAMAGES ARISING FROM YOUR USE OF THE WEBSITE. OUR LIABILITY IS
            LIMITED TO THE AMOUNT PAID TO US IN THE LAST 12 MONTHS.
            Indemnification You agree to indemnify and hold harmless Alpha
            Strategy LLC from claims arising from your violation of these terms.
            Dispute Resolution Disputes shall be resolved through: Informal
            negotiation If unresolved, through arbitration under Spanish law
            Proceedings shall be conducted in Barcelona, Spain Governing Law
            These terms are governed by Spanish law. You submit to the exclusive
            jurisdiction of Spanish courts. Time Limitation Claims must be
            commenced within one year after the cause of action arises. Contact
            Information Alpha Strategy LLC Barcelona, Spain Email:{" "}
            <a
              href="mailto:info@alphastrategy.io"
              className="text-blue-600 underline hover:text-blue-800 transition"
            >
