          ...
          <Box className="p-4 rounded-[6px] bg-white flex gap-4 lg:max-w-[400px] border-2 border-[#E5E7EB] mx-2 h-full">
            ...
            <Box className="text-[#3A2206] flex-1">
              ...
              <Text className="font-normal text-sm">
                Alpha Strategy (including Goya and any other person including,
                but not limited to, other staff members, guests, personalities,
                etc.) is not an investment adviser, and it is not registered as
                such with the U.S. Securities & Exchange Commission or any other
                state or federal authority under the Investment Advisers Act of
                1940 or any other law. The results generated by the Stock
                Analyzer Tool are for informational and educational purposes
                only and are not, and should not be considered, investment
                advice or a recommendation to buy, sell, or hold a particular
                security, make a particular investment, or follow a particular
                investing strategy.
              </Text>
            </Box>
          </Box>
